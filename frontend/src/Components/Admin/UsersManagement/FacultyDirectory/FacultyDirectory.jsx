...
const FacultyDirectory = () => {
    ...
    useEffect(() => {
        document.title = "Faculty Directory - Admin Portal";
        fetchFaculty();
    }, []);
    ...
    const fetchFaculty = async () => {
        try {
            ...
            // Filter only faculty (teacher role)
            const faculty = response.data.filter(user => user.role === 'teacher');
            setUsers(faculty);
            setLoading(false);
        } catch (err) {
                ...
                <header className="header">
                    ...
                    <div className="header-actions">
                        ...
                        <button className="primary-action-btn" onClick={() => navigate('/admin/create-user')}>
                            <UserPlus size={18} /> <span>New Faculty</span>
                        </button>
                    </div>
                </header>
                ...
                <AnimatePresence mode="wait">
                    {error ? (
                        ...
                        >
                            ...
                            <button onClick={fetchFaculty}>Re-attempt Connection</button>
                        </motion.div>
                    ) : (
                        <motion.div
                            key="table"
